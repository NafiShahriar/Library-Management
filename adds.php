        ...
        <div class="container">
            <div class="row">
                <form action="" method="post" class="col-md-12"  enctype="multipart/form-data">
                    ...
                    <div class="sigle-input col-md-12">
                        <label class="col-md-3">Name : <font color="teal"><i>*(required)</i></font></label>
                        <input class="col-md-8" type="text" name="Name" placeholder="Name of the Student">
                    </div>
                    <div class="sigle-input col-md-12">
...
//Insert
        ...
        if (isset($_POST['submit'])) {
            ...
            $query = "INSERT INTO student (sid,Name,Dept) VALUES ('$id','$Name','$Catagory')";
