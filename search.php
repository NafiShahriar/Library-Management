 ...
 <head>
    ...
    <body>
        ...
        <div class="container text-center">
            <div class="row">
                <div class="head_page col-md-10" align="left">
                    <div class="txt" ><h3>Search By Book name: </h3></div>
                </div>
            </div>
        </div>
        ...
        <div class="container text-center">
            <div class="row">
                <div class="head_page col-md-12" align="left" >
                    <div class="txt" ><h3>Search By Author: </h3></div>
                </div>
            </div>
        </div>
        ...
        <div class="container text-center">
            <div class="row">
                <div class="head_page col-md-12" align="left" >
                    <div class="txt" ><h3>Search By Depertment: </h3></div>
                </div>
            </div>
        </div>
        ...
        if (isset($_POST['search_btn1'])) {
            ...
            $show_query = "select * from (SELECT *  from bookdetails ) as result where name LIKE '%{$key}%'";
            $b = 1;
         ...
         if (isset($_POST['search_btn4'])) {
            $key = $_POST['catagory'];
            $con = mysqli_connect("localhost", "root", "", "bookinfo");
            $show_query = "select * from (SELECT *  from bookdetails ) as result where depertment LIKE '%{$key}%'";
            $b = 1;
        ...
        if (isset($_POST['search_btn2'])) {
            ...
            $con = mysqli_connect("localhost", "root", "", "bookinfo");
            $show_query = "select * from (SELECT *  from bookdetails ) as result where author LIKE '%{$key}%'";
            $d = 1;
